...
class T2InputGrid(object):
    """
        ...
        - Dictionary that returns the interface area for heat exchange 
          ...
          This area is only nonzero if the cell is in the upper or lower 
        ...
        for i in range(self.nx):
            ...
            for j in range(self.ny):
                ...
                for k in range(self.nz):
                    ...
                    # if the cell is at the upper or lower domain boundary, specify the area
                    if k == 0 or k == self.nz-1:
                        self.ahtx[eleme] = dy * dx 
                    else:
                        self.ahtx[eleme] = 0.
